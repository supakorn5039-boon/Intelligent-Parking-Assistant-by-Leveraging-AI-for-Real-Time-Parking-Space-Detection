...
const Car = () => {
  ...
  const [latestDocId30th, setLatestDocId30th] = useState("");

  // Firebase to show on 30th COmputer Building
  // const fetchAvailable30thFromFirebase = async () => {
  //   try {
  //     const querySnapshot = await firestore()
  //       .collection("available-lot")
  //       .where("location", "==", "30th Computer")
  ...
  //       const availableValue = doc.data().available;
  //       const docId = doc.id;

  //       setAvailable30th(availableValue);
  //       setLatestDocId30th(docId);
  //     }
  //   } catch (error) {
        ...
        <View>
          <TouchableOpacity onPress={handleButtonClick} style={styles.sq}>
            ...
            <View>
              ...
              {/* <Text> Available : {available30th} </Text> */}
            </View>
          </TouchableOpacity>

          {/* Modal When click on Button */}
          <Modal
            transparent={true}
            animationType="slide"
