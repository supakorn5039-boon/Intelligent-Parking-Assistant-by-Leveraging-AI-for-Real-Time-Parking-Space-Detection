...
const parkingsSpots = [
  {
    ...
    description: `This is a Parking for Motor Cycle near Hockey Field `,
  },

  {
    ...
    description: `This is a Parking for Car in Faculty of Engineering`,
  },
  {
    id: 3,
    title: "Mc30",
    ...
    description: `This is a Parking for Motor Cycle near 30-year-Faculty of Engineering`,
  },
  {
    id: 4,
    title: "Car",
    ...
    description: `This is a Parking for Car ,It's a new Building  `,
  },
  {
    id: 5,
    title: "MCL",
    ...
    description: `This is a Parking for Motor Cycle near Library in Faculty of Engineering`,
  },
  {
    id: 6,
    title: "MCF",
    ...
    description: `This is a Parking for Motor Cycle Front of Faculty of Engineering `,
  },
];
...
class ParkingMap extends Component {
  ...
  handleParkingLOTResponse = (ParkingLot) => {
    if (ParkingLot) {
      console.log("Parking confirmed.");

      this.props.navigation.navigate("ParkingLot");
    } else {
      ...
      <SafeAreaView>
        <View style={styles.header}>
          <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            <Text style={styles.headerLocation}>Chiangmai, Thailand</Text>
          </View>
          <View
            style={{
              flex: 1,
        ...
        <View style={styles.modal}>
          <View style={styles.modal}>
            ...
            <View>
              <TouchableOpacity
                style={styles.payBtn}
                onPress={() => this.handleCarResponse(true)}
              >
